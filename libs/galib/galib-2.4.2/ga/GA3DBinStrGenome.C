// $Header: /usr/people/mbwall/src/galib/ga/RCS/GA3DBinStrGenome.C,v 1.2 1996/11/13 16:53:57 mbwall Exp mbwall $
/* ----------------------------------------------------------------------------
  binstr3.C
  mbwall 19apr95
...
{
  if(this == &c) return 1;
  GA3DBinaryStringGenome & b = (GA3DBinaryStringGenome &)c;
...
GA3DBinaryStringGenome::BitComparator(const GAGenome& a, const GAGenome& b){
  GA3DBinaryStringGenome &sis=(GA3DBinaryStringGenome &)a;
  GA3DBinaryStringGenome &bro=(GA3DBinaryStringGenome &)b;
