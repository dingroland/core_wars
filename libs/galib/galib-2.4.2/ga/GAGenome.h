// $Header: /usr/people/mbwall/src/galib/ga/RCS/GAGenome.h,v 1.1 1996/11/13 01:36:31 mbwall Exp mbwall $
/* ----------------------------------------------------------------------------
  genome.h
  mbwall 28jul94
...
Genome
-------------------------------------------------------------------------------
  This should be a pure virtual (abstract) class, except that we need to have
GAGenome pointers running around because we never know what kind of
genome we have until we look at it.  As a result, the base class is not
abstract.
