// $Header: /usr/people/mbwall/src/galib/ga/RCS/GASelector.h,v 1.1 1996/11/13 01:36:31 mbwall Exp mbwall $
/* ----------------------------------------------------------------------------
  selector.h
  mbwall 10aug94
...
public:
  ...
  virtual void copy(const GASelectionScheme& orig) {
    if(sameClass(orig)){
      ...
      GARouletteWheelSelector& sel = (GARouletteWheelSelector&)orig;
      delete [] psum;
      n = sel.n; 
      psum = new float[n];
...
public:
  ...
  virtual void copy(const GASelectionScheme& orig) {
    if(sameClass(orig)){
      GASelectionScheme::copy(orig);
      GASRSSelector& sel = (GASRSSelector&)orig;
...
public:
  ...
  virtual void copy(const GASelectionScheme& orig) {
    if(sameClass(orig)){
      GASelectionScheme::copy(orig);
      GADSSelector& sel = (GADSSelector&)orig;
