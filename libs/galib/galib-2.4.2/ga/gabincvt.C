// $Header: /usr/people/mbwall/src/galib/ga/RCS/gabincvt.C,v 1.2 1996/11/13 16:53:57 mbwall Exp mbwall $
/* ----------------------------------------------------------------------------
  bincvt.C
  mbwall 29jun95
...
static int _GAEncodeBase(int, unsigned BITBASE, GABit *, int, int);
...
---------------------------------------------------------------------------- */
static int
_GAEncodeBase(int base, unsigned BITBASE val, GABit * binstr, int n, int c)
{
  int status = 0;
