// $Header: /usr/people/mbwall/src/galib/ga/RCS/gaid.h,v 1.1 1996/11/13 01:36:31 mbwall Exp mbwall $
/* ----------------------------------------------------------------------------
  id.h
  mbwall 7may95
...
(even if they do NOT share any other attributes).
 ...
 TO DO:
*** it would be nice to make the ids idiot proof - right now it is possible to
    assign an id that is already in use.  The tradeoff here is ease of defining
    a new class vs idiotproofness.
