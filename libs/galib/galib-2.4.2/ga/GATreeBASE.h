// $Header: /usr/people/mbwall/src/galib/ga/RCS/GATreeBASE.h,v 1.1 1996/11/13 01:36:31 mbwall Exp mbwall $
/* ----------------------------------------------------------------------------
  treebase.h
  mbwall 25nov94
 ...
 TO DO:
  Need to go through this file to type-safe everything.  For example, the
GATreeBASE routines that require nodes as args should be made protected.
