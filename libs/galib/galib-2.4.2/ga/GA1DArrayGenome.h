// $Header: /usr/people/mbwall/src/galib/ga/RCS/GA1DArrayGenome.h,v 1.1 1996/11/13 01:36:31 mbwall Exp mbwall $
/* ----------------------------------------------------------------------------
  array1.h
  mbwall 25feb95
...
public:
  ...
  const T & operator[](unsigned int x) const {return a[x];}
  T & operator[](unsigned int x) {_evaluated = gaFalse; return a[x];}
