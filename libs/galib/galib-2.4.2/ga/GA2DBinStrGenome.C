// $Header: /usr/people/mbwall/src/galib/ga/RCS/GA2DBinStrGenome.C,v 1.2 1996/11/13 16:53:57 mbwall Exp mbwall $
/* ----------------------------------------------------------------------------
  binstr2.C
  mbwall 19apr95
...
GA2DBinaryStringGenome::copy(const GAGenome & orig)
{
  ...
  GA2DBinaryStringGenome & c = (GA2DBinaryStringGenome &)orig;
  GAGenome::copy(orig);
...
// bits get set randomly to 0 or 1.
  ...
  if(h > (int)ny){		// change in height is always new bits
...
{
  GA2DBinaryStringGenome &child=(GA2DBinaryStringGenome &)c;
...
GA2DBinaryStringGenome::BitComparator(const GAGenome& a, const GAGenome& b){
  GA2DBinaryStringGenome &sis=(GA2DBinaryStringGenome &)a;
  GA2DBinaryStringGenome &bro=(GA2DBinaryStringGenome &)b;
...
UniformCrossover(const GAGenome& p1, const GAGenome& p2, 
  ...
  if(c1 && c2){
    GA2DBinaryStringGenome &sis=(GA2DBinaryStringGenome &)*c1;
    GA2DBinaryStringGenome &bro=(GA2DBinaryStringGenome &)*c2;
    ...
    GA2DBinaryStringGenome &sis =
      (c1 ? (GA2DBinaryStringGenome&)*c1 : (GA2DBinaryStringGenome&)*c2);
