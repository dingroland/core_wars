// $Header: /usr/people/mbwall/src/galib/ga/RCS/garandom.h,v 1.1 1996/11/13 01:36:31 mbwall Exp mbwall $
/* ----------------------------------------------------------------------------
  random.h
  mbwall 29jun95
...
inline int GARandomInt(int low, int high){ 
  float val=high-low+1; val*=_GA_RND(); return ((int)val+low);
}
...
void GARandomSeed(unsigned seed=0);
int GARandomBit();
