// $Header: /usr/people/mbwall/src/galib/ga/RCS/GAArray.h,v 1.1 1996/11/13 01:36:31 mbwall Exp mbwall $
/* ----------------------------------------------------------------------------
  arraytmpl.h
  mbwall 22apr95
...
/* ----------------------------------------------------------------------------
This can be used only on objects that have a public operator= defined (because
of the resize).
Must have a creation operator defined that takes no args
